...
#Created on Wed Nov  1 09:33:53 2023
...
"""Visualization of integrated Intensity HL-maps with linecutting for I4/mmm
Eu(Ga,Al)4
...
yzoomindex = 21  #  Zoom-window centered L-cut value   -->indecesy
st = time.time()
# img = "/Users/stevengebel/PycharmProjects/EuGaAl_P07/DESY P07 April 2023/Ga2Al2/processed/Ga2Al2.edf"
# obj = fabio.open(img)
# data = obj.data
...
# =============================================================================
    ...
    # =========================================================================
            ...
            plt.imshow(data, cmap=cmap, origin='lower',
                        ...
                        aspect='auto'  # Makes pixels quadratic 
                        )
            #  #  Plot Linecut-lines
            ...
            plt.ylim(-7, 7)  #  qyrange[indicesy[12]], qyrange[indicesy[-12]]
            plt.xlim(-4, 3)  #  qxrange[indicesx[4]], qxrange[indicesx[-5]]
            plt.xlabel('H (r.l.u.)')
            plt.ylabel('L (r.l.u.)')
            plt.colorbar()
