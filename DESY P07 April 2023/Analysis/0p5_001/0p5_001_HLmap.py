...
#     INPUT FOR LINECUT
# =============================================================================
xzoomindex = 0  #  Linecut integer H value  -->indecesx
yzoomindex = 13  #  Zoom-window centered L-cut value   -->indecesy
st = time.time()
for item in os.listdir(directory):
# =============================================================================
#     HL MAPS
# =============================================================================
    if not item.startswith('.') and item.startswith('0p5_001_H') and item.endswith('L_0.5A.img') and os.path.isfile(os.path.join(directory, item)):
            ###################################################################
            # INPUT FOR HL-maps
            img = item
    ...
    # =========================================================================
            ...
            plt.title("{}, sum of ±{}-pixel n.-neighbors".format(img,nmax))
    ...
    # =========================================================================
            for i in indicesx[xzoomindex:xzoomindex+1]:
                ...
                # https://stackoverflow.com/questions/68653746/sum-of-positive-
                # arrays-yields-negative-results
                I = []
    ...
    # =========================================================================
            ...
            plt.ylim(qyrange[indicesy[8]], qyrange[indicesy[29]])
            plt.xlim(qxrange[indicesx[0]], qxrange[indicesx[6]]) 
            plt.xlabel('H (r.l.u.)')
            plt.ylabel('L (r.l.u.)')
            plt.colorbar()
