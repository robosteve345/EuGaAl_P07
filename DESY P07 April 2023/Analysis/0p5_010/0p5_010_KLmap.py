#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Created on Wed Nov  1 13:37:43 2023
...
Data manipulations made in this script: 
    For Linecuts
...
def find_nearest(array, value):
    """Finds indeces of 1d-arrays for values that are nearest to "value""" 
...
#             INPUT FOR LINECUT
# =============================================================================
xzoomindex = 14  #  Linecut integer K value  -->indecesx
yzoomindex = 27  #  Zoom-window centered L-cut value   -->indecesy
st = time.time()
for item in os.listdir(directory):
# =============================================================================
#     KL MAPS
# =============================================================================
    ...
    # =========================================================================
            ...
            plt.ylim(qyrange[indicesy[9]], qyrange[indicesy[-9]])
            plt.xlim(qxrange[indicesx[9]], qxrange[-1]) 
            plt.xlabel('K (r.l.u.)')
            plt.ylabel('L (r.l.u.)')
            plt.colorbar()
