...
def main():
    ...
    #                                                                                              opt[6], opt[5]))
    #     T_weinstein.append(weinstein_temp(I1, I2))
    ...
    # else:
    #     pass
    T_sensor = [293, 293, 293, 293, 292.549, 292.594, 276.886, 276.886, 269.895, 269.895, 261.280, 261.280, 254.412,
                254.412,
                248.629, 248.629, 239.749, 239.729, 228.795, 228.795, 228.795, 204.019, 204.019, 204.019, 196.376,
                196.376, 181.817, 181.817, 174.102, 174.102,
                ...
                13.106]
    print(len(T_sensor))
    I1, I2, R1, R2, dR1, dR2 = np.loadtxt("../../Warming/Fulldata.txt", usecols = (8, 10, 0, 4, 1, 5), unpack = True)
    print(I1, I2)
    T_weinstein = weinstein_temp(I2, I1)
    print(len(T_weinstein))
    print(T_weinstein)
    print(T_weinstein-T_sensor)
    ...
    # plt.errorbar(T_sensor, R1, yerr=dR1, c='b', label=r'R$_1$', marker='.', ls='', capsize=3)
    # plt.errorbar(T_sensor, R2, yerr=dR2, c='g', label='R$_2$', marker='.', ls='', capsize=3)
    plt.errorbar(T_weinstein, R1, yerr=dR1, c='b', label=r'R$_1$, weinstein', marker='x', ls='', capsize=3)
    plt.errorbar(T_weinstein, R2, yerr=dR2, c='g', label='R$_2$, weinstein', marker='x', ls='', capsize=3)
    plt.xlabel("T$_{weinstein}$(K)")
    plt.ylabel(r"R$_{1,2}$(nm)")
    plt.xlim(0, 300)
