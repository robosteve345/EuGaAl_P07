...
def main():
    ...
    if speicherueberpruefung == "y":
        np.savetxt(r"/Users/stevengebel/PycharmProjects/Eu(Ga,Al)4 @ BSc&DESY P07/Rubyspecanalysis/Rubyspecfitdata2.txt",
    ...
    T_sensor = [293, 293, 293, 293, 292.549, 292.594, 276.886, 276.886, 269.895, 269.895, 261.280, 261.280, 254.412, 254.412, 248.629, 248.629, 239.749, 239.729, 228.795, 228.795, 228.795, 204.019]
