...
"""Application to fit ruby-spectra to double gaussians stored in .txt-files in the same directory with help of input-dialogue"""
...
def main():
    ...
    for spectrum in sorted_spectra:
        ...
        if saveplot == "y":
            plt.savefig("{}.jpg".format(spectrum), dpi=500)
        else:
            pass
