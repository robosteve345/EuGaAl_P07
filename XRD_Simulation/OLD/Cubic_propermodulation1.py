...
def structurefactorandplotting(a, c, k0, l0, k2d, k, kmax, lmax, l2d, h, deltak, Unitary, 
    ...
    for n in N:
        ...
        plt.xlabel("L(rlu)")
        plt.savefig("/Users/stevengebel/PycharmProjects/EuGaAl_P07/XRD_Simulation/BCC_modulation1/Linecuts_BCC_{}UC_{}SC_A={}_q={}_H={}_center{}{}{}.jpg".format(n, int(n/int(q_cdw**(-1))), Amplitude, q_cdw, h, h, k0, l0), dpi=300)
